...
The mobile-layout capability defines the viewport, safe-area, and responsive zoom behaviours that ensure the application renders correctly on mobile browsers (iOS Safari, Android Chrome) without unexpected scroll or clipping.
